...
namespace IdentityServer.UnitTests.Extensions
{
    public class IdentityServerBuilderExtensionsCryptoTests
    {
        ...
        public void AddSigningCredential_with_valid_curve_should_succeed(
            string curveOid,
            string alg
        )
        {
            ...
            var key = new ECDsaSecurityKey(
                ECDsa.Create(ECCurve.CreateFromOid(Oid.FromOidValue(curveOid, OidGroup.All)))
            );
        ...
        public void AddSigningCredential_with_invalid_curve_should_throw_exception(
            string curveOid,
            string alg
        )
        {
        ...
        [Theory]
        [InlineData(
            Constants.CurveOids.P256,
            SecurityAlgorithms.EcdsaSha256,
            JsonWebKeyECTypes.P256
        )]
        [InlineData(
            Constants.CurveOids.P384,
            SecurityAlgorithms.EcdsaSha384,
            JsonWebKeyECTypes.P384
        )]
        [InlineData(
            Constants.CurveOids.P521,
